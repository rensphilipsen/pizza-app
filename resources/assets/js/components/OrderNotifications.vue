<template>
    <li class="nav-item dropdown">
        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
            ...
            <span class="notification-count badge badge-danger" v-if="notifications.length > 0">{{ notifications.length }}</span>
            ...
            <li v-for="notification in notifications">
                <a :href="notification.url">
                    <div>
                        ...
                        <span class="pull-right text-muted small"><timeago :since="notification.time"
        ...
        mounted() {
            Echo.channel('pizza-tracker')
                .listen('OrderStatusChanged', (order) => {
                    if (parseInt(this.user_id) === order.user_id) {
